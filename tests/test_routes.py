...
def test_create_one_book_missing_no_data(client):
    # Act
...
def test_create_one_book_missing_title_raises_error(client):
    # Arrange
...
def test_create_one_book_missing_description_raises_error(client):
    # Arrange
